...
$bpge_admin_free = new BPGE_FREE_ADMIN();

class BPGE_FREE_ADMIN extends BPGE_ADMIN {

    // Declare Tabs
    public $general_settings_key = 'general';
    public $sets_settings_key    = 'sets';
    public $groups_settings_key  = 'groups';
    public $tuts_settings_key    = 'tuts';
    public $more_settings_key    = 'more';
    ...
    function __construct() {
        ...
        if(isset($_GET['page']) && $_GET['page'] == $this->slug){
            ...
            add_action( 'admin_init', array( &$this, 'register_tuts_settings' ) );
     ...
     * Tutorials data
     */
    function register_tuts_settings(){
        $this->bpge_tabs[$this->tuts_settings_key] = '<span></span>'.__('Tutorials', 'bpge');

        register_setting( $this->tuts_settings_key, $this->tuts_settings_key );
        add_settings_section( 'tuts_settings', '', array( &$this, 'display_tuts' ), $this->tuts_settings_key );
    }

    function display_tuts(){
        echo '<p class="description">';
    ...
    function register_more_settings(){
        $this->bpge_tabs[$this->more_settings_key] = '<span></span>'.__('More', 'bpge');

        register_setting( $this->more_settings_key, $this->more_settings_key );
        add_settings_section( 'more_settings', '', array( &$this, 'display_more' ), $this->more_settings_key );
    }
