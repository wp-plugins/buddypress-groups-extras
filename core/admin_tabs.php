...
class BPGE_ADMIN{
    ...
    private $tuts_settings_key    = 'tuts';
    private $more_settings_key    = 'more';
    ...
    function add_admin_menu() {
        ...
        if(isset($_GET['tab']) && $_GET['tab'] == $this->tuts_settings_key){
        ...
        add_action('admin_print_scripts-' . $this->pagehook, array($this, 'load_js'));
